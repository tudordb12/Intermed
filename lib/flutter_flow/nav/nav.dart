...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'art1',
          path: '/art1',
          builder: (context, params) => Art1Widget(),
        ),
        FFRoute(
          name: 'art2',
          path: '/art2',
        ...
        FFRoute(
          name: 'art3',
          path: '/art3',
          builder: (context, params) => Art3Widget(),
        ),
        FFRoute(
          name: 'art4',
          path: '/art4',
          builder: (context, params) => Art4Widget(),
        ),
        FFRoute(
          name: 'search',
          path: '/search',
        ...
        FFRoute(
          name: 'notio',
          path: '/notio',
          builder: (context, params) => NotioWidget(),
        ),
        FFRoute(
          name: 'qrr',
          path: '/qrr',
          builder: (context, params) => QrrWidget(),
        ),
        FFRoute(
          name: 'chat',
          path: '/chat',
        ...
        FFRoute(
          name: 'cl3',
          path: '/cl3',
          builder: (context, params) => Cl3Widget(
            press: params.getParam('press', ParamType.bool),
          ),
        ),
        FFRoute(
